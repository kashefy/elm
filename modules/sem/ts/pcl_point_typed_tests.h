...
#define SEM_SET_EXPECTED_POINT_FIELD_COUNT(TPoint, c)   template<> const size_t ExpectedPointAttr_<TPoint>::field_count = c
#define SEM_SET_EXPECTED_POINT_NB_FLOAT(TPoint, n)  template<> const size_t ExpectedPointAttr_<TPoint>::nb_floats = n
#define SEM_SET_EXPECTED_POINT_NAME(TPoint)         template<> const std::string ExpectedPointAttr_<TPoint>::name = #TPoint
