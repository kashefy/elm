...
{
    EXPECT_EQ(CV_8S,  static_cast<int>(MATIOClassTOCV_TYPE(MAT_C_CHAR)));
    EXPECT_EQ(CV_64F, static_cast<int>(MATIOClassTOCV_TYPE(MAT_C_DOUBLE)));
    EXPECT_EQ(CV_8U,  static_cast<int>(MATIOClassTOCV_TYPE(MAT_C_UINT8)));
    EXPECT_EQ(CV_16U, static_cast<int>(MATIOClassTOCV_TYPE(MAT_C_UINT16)));
    EXPECT_EQ(CV_8S,  static_cast<int>(MATIOClassTOCV_TYPE(MAT_C_INT8)));
    EXPECT_EQ(CV_16S, static_cast<int>(MATIOClassTOCV_TYPE(MAT_C_INT16)));
    EXPECT_EQ(CV_32S, static_cast<int>(MATIOClassTOCV_TYPE(MAT_C_INT32)));
    EXPECT_EQ(CV_32F, static_cast<int>(MATIOClassTOCV_TYPE(MAT_C_SINGLE)));
}
