...
optional<translator_VecI::external_type>
translator_VecI::get_value(const internal_type& str)
{
    if (!str.empty())
    {
...
boost::optional<translator_VecI::internal_type>
translator_VecI::put_value(const external_type& x)
{
